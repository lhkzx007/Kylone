...
public class MarqueeTextView extends TextView {
     ...
     * 滚动模式-按次数滚动
     */
    public static final int SCROLL_COUNT = 102;
...
//        typedArray.recycle();
    ...
    public void resumeScroll() {
        ...
        if (mMarqueeListener != null) {
            mMarqueeListener.marquee(countIndex);
        }
    }
...
//        String strTxt = getText().toString();
    ...
    public void computeScroll() {
        ...
        if (mScroller.isFinished() && (!mPaused)) {
            ...
            if (mScrollMode == SCROLL_COUNT && mScrollCount == countIndex) {
                stopScroll();
                return;
            }
            mPaused = true;
    ...
    public void setScrollCount(int mScrollCount) {
        setScrollMode(MarqueeTextView.SCROLL_COUNT);
        this.mScrollCount = mScrollCount;
    }

    public void setOnMarqueeListener(OnMarqueeListener marqueeListener) {
